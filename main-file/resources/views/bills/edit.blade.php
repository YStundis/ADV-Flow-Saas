...
@php
    ...
    if(Auth::user()->type == 'client'){
        $settings = Utility::getCompanyPaymentSetting(Auth::user()->created_by);
    }
    else{
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <div class="form-group" id="advocate_div">
                                        {{ Form::label('advocate', __('Advocate'), ['class' => 'form-label']) }}
                                        {{ Form::select('advocate', $advocates, $bill->advocate, ['class' => 'form-control multi-select item','id'=>'selected-advocate']) }}
                                    </div>
                                    ...
                                    <div class="form-group  " id="custom_advocate_div">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <span>{{Utility::getcompanydetailValByName('mobile_number')}}</span><br>
                                                <label class="col-3 mb-2">{{__('Address:')}} </label>
                                                <span> {{Utility::getcompanydetailValByName('address') }}</span>
                                        </div>
                                        </div>
                                    </div>
