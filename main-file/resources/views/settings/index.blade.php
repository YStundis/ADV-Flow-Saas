                                                                        ...
                                                                        <div class="form-check">
                                                                            <label class="form-check-labe text-dark">
                                                                                <input type="radio"
                                                                                    ...
                                                                                    class="form-check-input"
                                                                                    {{ !isset($company_payment_setting['midtrans_mode']) || $company_payment_setting['midtrans_mode'] == '' || $company_payment_setting['midtrans_mode'] == 'local'
                                                                                        ? 'checked="checked"'
                                                                                        : '' }}>
                                                                                {{ __('Local') }}
                                                                            </label>
                                                                        ...
                                                                        <div class="form-check">
                                                                            <label class="form-check-labe text-dark">
                                                                                <input type="radio"
                                                                                    ...
                                                                                    value="production"
                                                                                    class="form-check-input"
                                                                                    {{ isset($company_payment_setting['midtrans_mode']) && $company_payment_setting['midtrans_mode'] == 'production' ? 'checked="checked"' : '' }}>
                                                                                {{ __('Production') }}
                                                                            </label>
                                                                        </div>
                                                                    </div>
