                                    ...
                                    @foreach ($fees as $expense)
                                        <tr>
                                            <td><a href="#" class="btn btn-sm"
                                                    data-url="{{ route('fee-receive.show', $expense->id) }}"
                                                    data-size="md" data-ajax-popup="true"
                                                    data-title="{{ __(' View Fee') }}">
                                            ...
                                            <td>
                                                @can('view feereceived')
                                                    <div class="action-btn bg-light-secondary ms-2">
                                                        <a href="#"
                                                            ...
                                                            data-url="{{ route('fee-receive.show', $expense->id) }}"
                                                            data-size="md" data-ajax-popup="true"
                                                            data-title="{{ __(' View Fee') }}" title="{{ __('View Fee') }}"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"><i
                                                                class="ti ti-eye "></i></a>
                                                    </div>
                                                @endcan
                                                @can('edit feereceived')
                                                    <div class="action-btn bg-light-secondary ms-2">
                                                        <a href="#"
                                                            class="mx-3 btn btn-sm d-inline-flex align-items-center "
                                                            data-url="{{ route('fee-receive.edit', $expense->id) }}"
                                                            data-size="md" data-ajax-popup="true"
                                                            data-title="{{ __('Edit Fee') }}" title="{{ __('Edit ') }}"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"><i
                                                                class="ti ti-edit "></i>
                                                        </a>
                                                    </div>
