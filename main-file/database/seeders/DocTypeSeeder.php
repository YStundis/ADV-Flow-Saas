...
class DocTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        $doctype = [
            ...
            ['name' => 'Stipulation/Agreement', 'description' => 'A written agreement between the parties, submitted to the court for approval, outlining Termos e Condições agreed upon in the case', 'created_by' => '2'],
            ...
            ['name' => 'Settlement Agreement', 'description' => 'A document detailing the Termos e Condições agreed upon by the parties to resolve the case outside of court, often submitted to the court for approval and entry as a final judgment.', 'created_by' => '2'],
