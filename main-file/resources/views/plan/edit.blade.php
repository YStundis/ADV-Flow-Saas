...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('max_advocates', null, [
                'class' => 'form-control',
                'placeholder' => __('Enter Maximum Advocates'),
                'required' => 'required',
            ]) }}
            <span class="small">{{ __('Note: "-1" for Unlimited') }}</span>
        </div>
        ...
        <div class="col-md-4 mt-3 plan_price_div">
            ...
            <div class="form-group">
                ...
                <div class="form-check form-switch custom-switch-v1 float-end">
                    <input type="checkbox" name="enable_chatgpt" class="form-check-input input-primary " value="1"
                        id="enable_chatgpt" {{ $plan->enable_chatgpt == 'on' ? ' checked ' : '' }}>
                    <label class="form-check-label" for="enable_chatgpt"></label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check form-switch custom-switch-v1 float-end">
                    <input type="checkbox" name="trial" class="form-check-input input-primary pointer" value="1"
                        id="trial" {{ $plan->trial == 1 ? ' checked ' : '' }}>
                    <label class="form-check-label" for="trial"></label>
                </div>
            </div>
        </div>
        @endif
        <div class="col-md-4  {{ $plan->trial == 1 ? '  ' : 'd-none' }} plan_div plan_price_div">
            <div class="form-group">
