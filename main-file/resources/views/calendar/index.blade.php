                ...
                <div class="card-header ">
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control multi-select" name="calender_type" id="calender_type" style="float: right;width: 150px;" onchange="get_data()">
                        ...
                        <div class="col-md-4 col-6 my-2">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-2">
                                    ...
                                    <h4 class="mb-0 text-warning">{{ count($hearings) }}</h4>
                                        ...
                                        <div class="col-auto mb-3 mb-sm-0">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    ...
                                                    <i class="{{ $calenderData['data_name'] == 'hearing' ? 'ti ti-file-text' : 'ti ti-file-plus' }}"></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h6 class="m-0">
