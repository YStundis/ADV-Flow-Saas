                ...
                <div class="">
                    ...
                    @if(!empty($permissions))
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @php
                                    $modules=['dashboard','client','advocate','document','doctype','member','group','court','highcourt','bench','cause','case','casetype','todo','bill','tax','diary','timesheet','expense','feereceived','calendar','motions','setting'];
                                @endphp
