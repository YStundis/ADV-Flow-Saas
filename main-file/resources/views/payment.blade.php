    ...
    @if (isset($admin_payment_setting['is_payhere_enabled']) && $admin_payment_setting['is_payhere_enabled'] == 'on')
        <script>
            ...
            function get_payhere_status(amount, coupon) {
                ...
                $.ajax({
                    url: '{{ route('plan.payhere.payment') }}',
                    method: 'POST',
                    data: {
                        'plan_id': plan_id,
                        'coupon_amount': amount,
                    ...
                    <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                        ...
                        @if (isset($admin_payment_setting['is_paiementpro_enabled']) && $admin_payment_setting['is_paiementpro_enabled'] == 'on')
                            <a href="#paiementpro_payment"
                                class="list-group-item list-group-item-action border-0">{{ __('Paiementpro') }}<div
                                    class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        @endif
            ...
            <div class="col-xl-9">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="float-end">
                                                        ...
                                                        <button class="btn btn-primary d-flex align-items-center"
                                                            ...
                                                            (<span
                                                                class="bank-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }} (<span
                                                            class="toyyibpay-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="float-end">
                                                        ...
                                                        <button class="btn btn-primary d-flex align-items-center"
                                                            ...
                                                            <i class="mdi mdi-cash-multiple mr-1"></i>
                                                            {{ __('Pay Now') }} (<span
                                                                class="payfast-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="paytab-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="benefit-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 text-right cashfree-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="cashfree-coupon-price"></b>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="cashfree-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 text-right aamarpay-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="aamarpay-coupon-price"></b>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="aamarpay-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 text-right yookassa-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="yookassa-coupon-price"></b>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="yookassa-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 text-right midtrans-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="midtrans-coupon-price"></b>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="midtrans-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 text-right xendit-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="xendit-coupon-price"></b>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="xendit-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                ...
                @if (isset($admin_payment_setting['is_payhere_enabled']) && $admin_payment_setting['is_payhere_enabled'] == 'on')
                    ...
                    <div id="useradd-26" class="card  shadow-none rounded-0 border-bottom ">
                        <form class="w3-container w3-display-middle w3-card-4" method="post"
                            action="{{ route('plan.payhere.payment') }}">
                            @csrf
                            <div class="card-header">
                                <h5>{{ __('PayHere') }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 text-right payhere-coupon-tr" style="display: none">
                                        <b>{{ __('Coupon Discount') }}</b> : <b class="payhere-coupon-price"></b>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="float-end">
                                                ...
                                                <button class="btn btn-primary d-flex align-items-center"
                                                    ...
                                                    {{ __('Pay Now') }}
                                                    (<span
                                                        class="payhere-final-price">{{ $settings['site_currency_symbol'] ? $settings['site_currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                @if (isset($admin_payment_setting['is_paiementpro_enabled']) && $admin_payment_setting['is_paiementpro_enabled'] == 'on')
                    <div id="paiementpro_payment" class="card  shadow-none rounded-0 border-bottom ">
                        <form role="form" method="post" action="{{ route('plan.pay.with.paiementpro') }}"
                            ...
                            <div class="card-body">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 text-right paiementpro-coupon-tr" style="display: none">
                                        <b>{{ __('Coupon Discount') }}</b> : <b class="paiementpro-coupon-price"></b>
                                    </div>
                                </div>
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="paiementpro" value="{{ __('Pay Now') }}"
                                            id="pay_with_paiementpro"
                                            class="btn btn-xs btn-primary">{{ __('Pay Now') }}(<span
                                                class="paiementpro-final-price">{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="card-body">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 text-right nepalste-coupon-tr" style="display: none">
                                        <b>{{ __('Coupon Discount') }}</b> : <b class="nepalste-coupon-price"></b>
                                    </div>
                                </div>
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="nepalste" value="{{ __('Pay Now') }}"
                                            ...
                                            class="btn btn-xs btn-primary">{{ __('Pay Now') }}(<span
                                                class="nepalste-final-price">{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="card-body">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 text-right cinetpay-coupon-tr" style="display: none">
                                        <b>{{ __('Coupon Discount') }}</b> : <b class="cinetpay-coupon-price"></b>
                                    </div>
                                </div>
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="cinetpay" value="{{ __('Pay Now') }}"
                                            ...
                                            class="btn btn-xs btn-primary">{{ __('Pay Now') }}(<span
                                                class="cinetpay-final-price">{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div id="fedapay_payment" class="card shadow-none rounded-0 border-bottom">
                    <form role="form" action="{{ route('plan.pay.with.fedapay') }}" method="post" id="fedapay-payment-form" class="w3-container w3-display-middle w3-card-4">
                        @csrf
                    <div class="card-header">
                        <h5>{{ __('Fedapay') }}</h5>
                                ...
                                <div class="row mt-3">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 text-right fedapay-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="fedapay-coupon-price"></b>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="fedapay" value="{{ __('Pay Now') }}" id="pay_with_fedapay"
                                            class="btn btn-xs btn-primary" >{{ __('Pay Now') }}(<span class="fedapay-final-price">{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
