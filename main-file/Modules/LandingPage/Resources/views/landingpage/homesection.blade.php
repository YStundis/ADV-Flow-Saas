                ...
                <div class="card rounded-0 shadow-none bg-transparent">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('Confiado por', __('Trusted by'), ['class' => 'form-label']) }}
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                ...
                                                                <img src="{{ $logo . '/new_home_logo.png' }}" width="70px" id="home_logo"
                                                        ...
                                                        <div class="col-auto actions">
                                                            <a data-repeater-delete href="javascript:void(0)"
                                                                class="action-item btn btn-sm btn-icon btn-light-secondary ms-2 delete-button">
