...
class LandingPageDataTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data['home_live_demo_link'] = '#';
        $data['home_buy_now_link'] = '#';
        $data['home_banner'] = 'home_banner.png';
        $data['home_logo'] = 'site_logo.png,site_logo.png,site_logo.png,site_logo.png,site_logo.png,site_logo.png,site_logo.png';

        $data['feature_status'] = 'on';
        $data['feature_title'] = 'Recursos';
        ...
        $data['highlight_feature_heading'] = 'ADV Flow';
        ...
        $data['discover_heading'] = 'ADV Flow';
        ...
        $data['screenshots_heading'] = 'ADV Flow';
        $data['screenshots_description'] = 'Use these awesome forms to login or create new account in your project for free.';
        $data['screenshots'] = '[{"screenshots":"1688109087-screenshots.png","screenshots_heading":"Support Ticket"},{"screenshots":"1688109104-screenshots.png","screenshots_heading":"Calendar"},{"screenshots":"1688100981-screenshots.png","screenshots_heading":"Tickets"},{"screenshots":"1688109222-screenshots.png","screenshots_heading":"Payments"},{"screenshots":"1688108614-screenshots.png","screenshots_heading":"CRM Deals"},{"screenshots":"1688108626-screenshots.png","screenshots_heading":"Invoice"}]';

        $data['plan_status'] = 'on';
        $data['plan_title'] = 'Plan';
        $data['plan_heading'] = 'ADV Flow';
        $data['plan_description'] = 'Use these awesome forms to login or create new account in your project for free.';

        $data['faq_status'] = 'on';
        $data['faq_title'] = 'Faq';
        $data['faq_heading'] = 'ADV Flow';
