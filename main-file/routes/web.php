...
Route::resource('bills', BillController::class)->middleware(['XSS']);
...
Route::resource('referral', ReferralController::class)->middleware(['auth','XSS']);
Route::post('referral-settings', [ReferralController::class,'savereferralSettings'])->name('referral.settings')->middleware(['auth','XSS']);

Route::resource('payout', PayoutController::class)->middleware(['auth','XSS']);
Route::get('/payout/update/{id}/{status}', [PayoutController::class, 'update'])->name('payout.update')->middleware(['auth','XSS']);
...
// case-type
Route::resource('casetype', CaseTypeController::class)->middleware(['auth','XSS']);

//assgin_to
Route::post('/get-advocate', [ToDoController::class, 'assgineadvocate'])->name('get.advocate')->middleware(['auth','XSS']);
Route::post('/get-client', [ToDoController::class, 'assgineclient'])->name('get.client')->middleware(['auth','XSS']);
