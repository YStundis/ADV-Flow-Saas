    ...
    <section class="main-banner bg-primary" id="home">
        <div class="container-offset">
            <div class="row gy-3 g-0 align-items-center">
                <div class="col-xxl-4 col-md-6">
                    <span class="badge py-2 px-3 bg-white text-dark rounded-pill fw-bold mb-3" style="color: #060606 !important">
        ...
        <div class="container">
            <div class="row g-0 gy-2 mt-4 align-items-center">
                <div class="col-xxl-3">
                    <p class="mb-0">{{ __('Confiado por') }} <b
                    ...
                    @if ($key % 2 == 0)
                        <div class="row align-items-center justify-content-center mb-4">
                            <div class="col-lg-4 col-md-6">
                                <div class="title mb-4">
                                    <span class="d-block fw-bold mb-2 text-uppercase">{{ __('Recursos') }}</span>
                                    <h2>
    ...
    <section class="bg-dark section-gap">
        <div class="container">
            <div class="row mb-2 justify-content-center">
                <div class="col-xxl-6">
                    <div class="title text-center mb-4">
                        <span class="d-block mb-2 text-uppercase">{{ __('DESCOBRIR') }}</span>
    ...
    <section class="subscription bg-primary section-gap" id="plan">
        <div class="container">
            <div class="row mb-2 justify-content-center">
                <div class="col-xxl-6">
                    <div class="title text-center mb-4">
                        <span class="d-block mb-2 fw-bold text-uppercase">{{ __('PLANO') }}</span>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_users == -1 ? 'Ilimitado' : $value->max_users }}
                                                {{ __('Usuário') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_customers == -1 ? 'Ilimitado' : $value->max_customers }}
                                                {{ __('Personalização') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_venders == -1 ? 'Ilimitado' : $value->max_venders }}
                                                {{ __('Fornecedores') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_clients == -1 ? 'Ilimitado' : $value->max_clients }}
                                                {{ __('Clientes') }}</label>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->account == 1 ? 'Habilitado' : 'Desativado' }}
                                                {{ __('Conta') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->crm == 1 ? 'Habilitado' : 'Desativado' }}
                                                {{ __('CRM') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->hrm == 1 ? 'Habilitado' : 'Desativado' }}
                                                {{ __('Gestão de Recursos Humanos') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->project == 1 ? 'Habilitado' : 'Desativado' }}
                                                {{ __('Projeto') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->pos == 1 ? 'Habilitado' : 'Desativado' }}
                                                {{ __('POS') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->chatgpt == 1 ? 'Habilitado' : 'Desativado' }}
                                                {{ __('ChatGPT') }}</label>
                                        </div>
                                    </li>
                                ...
                                <div class="d-grid">
                                    <a href="{{ route('register') }}"
                                        class="btn btn-primary rounded-pill">{{ __('Começar') }} <i
    ...
    <section class="testimonial section-gap">
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="title mb-4">
                        <span class="d-block mb-2 fw-bold text-uppercase">{{ __('DEPOIMENTOS') }}</span>
                ...
                <div class="ftr-col ftr-subscribe">
                    ...
                    <form method="post" action="{{ route('join_us_store') }}">
                        ...
                        <div class="input-wrapper border border-dark">
                            ...
                            <button type="submit" class="btn btn-dark rounded-pill">{{ __('Junte-se a nós') }}!</button>
                        </div>
                    </form>
                </div>
            @endif
