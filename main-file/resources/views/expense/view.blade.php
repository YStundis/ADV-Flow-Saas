        ...
        <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-8"><span class="text-md">{{ App\Models\Cases::getCasesById($expense->case) }}</span>
                    </dd>
                    ...
                    <dd class="col-md-8"><span
                            class="text-md">{{ App\Models\Utility::getPaymentMethodName($expense->method) }}</span></dd>

                    <dt class="col-md-4"><span class="h6 text-md mb-0">{{ __('Member:') }}</span></dt>
                    <dd class="col-md-8"><span class="text-md">{{ App\Models\User::getTeams($expense->member) }}</span>
                    </dd>
