                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $('#highcourt_div').empty();
                            $('#highcourt_div').append('<label for="highcourt" class="form-label">High Court</label> <select class="form-control multi-select" name="highcourt" id="highcourt"> </select>');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 1) {
                            ...
                            $('#bench_div').empty();
                            $('#bench_div').append('<label for="bench" class="form-label">Circuit/Devision</label> <select class="form-control multi-select" name="bench" id="bench"> </select>');
