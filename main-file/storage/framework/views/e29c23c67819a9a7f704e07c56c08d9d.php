        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                <li
                    ...
                    <a class="dash-link" href="<?php echo e(route('referral.index')); ?>">
                ...
                <?php if(Auth::user()->type == 'company' ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage casetype')): ?>
                            <li class="dash-item ">
                                <a class="dash-link" href="<?php echo e(route('casetype.index')); ?>"><?php echo e(__('Case Type')); ?></a>
                            </li>
                            <?php endif; ?>
...
<!-- [ navigation menu ] end -->
<?php /**PATH /home/yuri/www/adv-flow/main-file/resources/views/partision/sidebar.blade.php ENDPATH**/ ?>