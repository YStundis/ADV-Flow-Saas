                                                ...
                                                <div class="accordion accordion-flush setting-accordion"
                                                    ...
                                                    <div class="accordion-item">
                                                            ...
                                                            aria-controls="collapse-nepalste">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox" class="form-check-input" name="is_nepalste_enabled" id="is_nepalste_enabled" {{ isset($payment['is_nepalste_enabled']) && $payment['is_nepalste_enabled'] == 'on' ? 'checked' : '' }}>
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="d-flex">
                                                                                ...
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label class="form-check-label text-dark">
                                                                                            <input type="radio" name="nepalste_mode" value="sandbox" class="form-check-input" {{ !isset($payment['nepalste_mode']) || $payment['nepalste_mode'] == '' || $payment['nepalste_mode'] == 'sandbox' ? 'checked="checked"' : '' }}>
                                                                                            {{ __('Sandbox') }}
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-3">
                                                                                <div class="border card p-3">
                                                                                    <div class ="form-check">
                                                                                        <label class="form-check-label text-dark">
                                                                                            <input type="radio" name="nepalste_mode" value="live" class="form-check-input" {{ isset($payment['nepalste_mode']) && $payment['nepalste_mode'] == 'live' ? 'checked="checked"' : '' }}>
                                                                                            {{ __('Live') }}
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="nepalste_public_key" id="nepalste_public_key" class="form-control" value="{{ !isset($payment['nepalste_public_key']) || is_null($payment['nepalste_public_key']) ? '' : $payment['nepalste_public_key'] }}" placeholder="{{ __('Nepalste Public Key') }}">
                                                                        </div>
                                                                    </div>
                                                                    {{-- <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="nepalste_secret_key" class="col-form-label">{{ __('Nepalste Secret Key') }}</label>
                                                                            <input type="text" name="nepalste_secret_key" id="nepalste_secret_key" class="form-control" value="{{ !isset($payment['nepalste_secret_key']) || is_null($payment['nepalste_secret_key']) ? '' : $payment['nepalste_secret_key'] }}" placeholder="{{ __('Nepalste Secret Key') }}">
                                                                        </div>
                                                                    </div> --}}
                                                                </div>
                                                            </div>
                                                     ...
                                                     <div class="accordion-item">
                                                        <h2 class="accordion-header" id="heading-cinetpay">
                                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-cinetpay" aria-expanded="true" aria-controls="collapse-cinetpay">
                                                                <span class="d-flex align-items-center">{{ __('Cinetpay') }}</span>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="me-2">{{__('Enable')}}:</span>
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        <input type="hidden" name="is_cinetpay_enabled" value="off">
                                                                        <input type="checkbox" class="form-check-input" name="is_cinetpay_enabled" id="is_cinetpay_enabled" {{ isset($payment['is_cinetpay_enabled']) && $payment['is_cinetpay_enabled'] == 'on' ? 'checked' : '' }}>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="cinetpay_api_key" id="cinetpay_api_key" class="form-control" value="{{ !isset($payment['cinetpay_api_key']) || is_null($payment['cinetpay_api_key']) ? '' : $payment['cinetpay_api_key'] }}" placeholder="{{ __('Cinetpay Api Key') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="cinetpay_site_id" class="col-form-label">{{ __('Cinetpay Site Id') }}</label>
                                                                            <input type="text" name="cinetpay_site_id" id="cinetpay_site_id" class="form-control" value="{{ !isset($payment['cinetpay_site_id']) || is_null($payment['cinetpay_site_id']) ? '' : $payment['cinetpay_site_id'] }}" placeholder="{{ __('Cinetpay Site Id') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="heading-fedapay">
                                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-fedapay" aria-expanded="true" aria-controls="collapse-fedapay">
                                                                <span class="d-flex align-items-center">{{ __('Fedapay') }}</span>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="me-2">{{__('Enable')}}:</span>
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        <input type="hidden" name="is_fedapay_enabled" value="off">
                                                                        <input type="checkbox" class="form-check-input" name="is_fedapay_enabled" id="is_fedapay_enabled" {{ isset($payment['is_fedapay_enabled']) && $payment['is_fedapay_enabled'] == 'on' ? 'checked' : '' }}>
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div class="col-lg-3" style="margin-right: 15px;">
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label class="form-check-label text-dark">
                                                                                            <input type="radio" name="fedapay_mode" value="sandbox" class="form-check-input" {{ !isset($payment['fedapay_mode']) || $payment['fedapay_mode'] == '' || $payment['fedapay_mode'] == 'sandbox' ? 'checked="checked"' : '' }}>
                                                                                            {{ __('Sandbox') }}
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-3">
                                                                                <div class="border card p-3">
                                                                                    <div class ="form-check">
                                                                                        <label class="form-check-label text-dark">
                                                                                            <input type="radio" name="fedapay_mode" value="live" class="form-check-input" {{ isset($payment['fedapay_mode']) && $payment['fedapay_mode'] == 'live' ? 'checked="checked"' : '' }}>
                                                                                            {{ __('Live') }}
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="fedapay_public_key" id="fedapay_public_key" class="form-control" value="{{ !isset($payment['fedapay_public_key']) || is_null($payment['fedapay_public_key']) ? '' : $payment['fedapay_public_key'] }}" placeholder="{{ __('Public Key') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="fedapay_secret_key" class="col-form-label">{{ __('Secret Key') }}</label>
                                                                            <input type="text" name="fedapay_secret_key" id="fedapay_secret_key" class="form-control" value="{{ !isset($payment['fedapay_secret_key']) || is_null($payment['fedapay_secret_key']) ? '' : $payment['fedapay_secret_key'] }}" placeholder="{{ __('Secret Key') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group col switch-width">
                                                ...
                                                {{ Form::select(
                                                    ...
                                                    $google_recaptcha_version,
                                                    isset($setting['google_recaptcha_version']) && $setting['google_recaptcha_version'] == 'v3'
                                                        ? 'v3'
                                                        : 'v2-checkbox',
