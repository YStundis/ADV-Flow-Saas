...
<head>
    ...
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'ADVFlow-SaaS') }}
                            ...
                            <a href="#">
                                @if ($settings['cust_darklayout'] && $settings['cust_darklayout'] == 'on')
                                    <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') . '?' . time() }}"
                                        alt="{{ config('app.name', 'ADVFlow-SaaS') }}" class="logo "
                ...
                <div class="auth-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span>&copy;
                                    {{ $settings['footer_text'] ? $settings['footer_text'] : config('app.name', 'ADV Flow') }}
                                    {{ date('Y') }}</span>
                            </div>
                        </div>
                    </div>
