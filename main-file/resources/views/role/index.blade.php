...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="lg" data-title="Add Role"
        data-url="{{ route('roles.create') }}" data-toggle="tooltip" title="{{ __('Create New Role') }}" data-bs-original-title="{{__('Create New Role')}}" data-bs-placement="top" data-bs-toggle="tooltip">
