...
{
  /**
   * Deletes a política de Privacidade. (privacyPolicies.delete)
   *
   * @param string $name Required. Resource name of the política de Privacidade.
  ...
  /**
   * Finds the política de Privacidade of a given website. (privacyPolicies.find)
   *
  ...
  /**
   * Gets a política de Privacidade. (privacyPolicies.get)
   *
   * @param string $name Required. Resource name of the política de Privacidade.
   * @param array $optParams Optional parameters.
