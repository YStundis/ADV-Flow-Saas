    ...
    @can('create coupon')
        <div class="col-md-12 d-flex justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary btn-icon" title="{{ __('Create') }}" data-bs-toggle="tooltip"
                data-bs-placement="top" data-ajax-popup="true" data-title="{{ __('Create New Coupon') }}"
                data-url="{{ route('coupons.create') }}"><i class="ti ti-plus"></i></a>
        </div>
    @endcan
@endsection
                        ...
                        <table class="table dataTable">
                            ...
                            <tbody>
                                @foreach ($coupons as $coupon)
                                    <tr class="">
                                        <td><a href="{{ route('coupons.show', $coupon->id) }}" class="btn btn-sm"
                                                title="{{ __('Detail') }}">
                                                {{ $coupon->name }}
                                            </a></td>
                                        <td>{{ $coupon->code }}</td>
                                        ...
                                        <td>
                                            <div class="action-btn bg-light-secondary ms-2">
                                                <a href="{{ route('coupons.show', $coupon->id) }}"
                                                    ...
                                                    title="{{ __('Detail') }}" data-bs-toggle="tooltip"
                                            ...
                                            @can('edit coupon')
                                                <div class="action-btn bg-light-secondary ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                        ...
                                                        data-size="md"><i class="ti ti-edit"></i></a>
                                                </div>
                                            @endcan
                                            @can('delete coupon')
                                                <div class="action-btn bg-light-secondary ms-2">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-bs-placement="top"><i class="ti ti-trash"></i></a>
                                                </div>
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
