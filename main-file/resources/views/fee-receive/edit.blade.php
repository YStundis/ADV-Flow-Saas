...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-12">
            ...
            {{-- {!! Form::select('case', $cases, $expense->case, ['class' => 'form-control multi-select']) !!} --}}
            <select class="form-control multi-select" name="case" id="case">
